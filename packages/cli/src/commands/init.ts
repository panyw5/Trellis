...
function getMathPhysicsBootstrapPrdContent(): string {
  return [
    ...
    "2. Separate engineering-level tests from mathematical and physical expectation checks.",
    "3. List benchmark cases, known results, and reference points for math-tests and phy-tests.",
    "4. Capture where each expected result comes from: proof, literature, computation, or physical argument.",
...
function getBootstrapTaskJson(
  ...
  if (profile === "math-physics") {
    return {
      ...
      commit: null,
      subtasks: [
        { name: "Fill definitions and notation guidelines", status: "pending" },
        {
