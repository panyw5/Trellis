...
function getMathPhysicsBootstrapPrdContent(): string {
  return [
    ...
    "|-----------|------------------|",
    "| `.trellis/spec/definitions/` | mathematical and physical definitions, notation, normalization, canonical forms |",
    "| `.trellis/spec/implementation/` | data representations, algorithm patterns, module boundaries, and caching rules |",
    "| `.trellis/spec/core-tests/` | programming-project tests, interface coverage, regression and quality expectations |",
    "| `.trellis/spec/math-tests/` | mathematical benchmark cases, identities, literature cross-checks |",
    "| `.trellis/spec/phy-tests/` | physical observables, symmetry expectations, consistency and limit checks |",
    "| `.trellis/spec/guides/` | thinking guides for turning definitions into implementations and validation plans |",
    "",
    "---",
    "",
    "## How to Fill These Guidelines",
    "",
    "1. Start from the definitions and notation your project relies on most often.",
    "2. Document how those definitions become concrete program structures inside implementation/.",
    "3. Separate engineering-level tests from mathematical and physical expectation checks.",
    "4. List benchmark cases, known results, and reference points for math-tests and phy-tests.",
    "5. Capture where each expected result comes from: proof, literature, computation, or physical argument.",
    "6. Keep failed attempts and edge-case surprises — they are part of the research context.",
    "",
    "---",
    "",
    "## Completion Checklist",
    "",
    "- [ ] definitions and notation are written down clearly",
    "- [ ] implementation explains how definitions become program structures and algorithms",
    "- [ ] core-tests describe engineering expectations for the codebase",
    "- [ ] math-tests reference concrete benchmark cases or literature",
    "- [ ] phy-tests describe the physical expectations or consistency checks that matter",
    "- [ ] guides explain how to move from definition to implementation and validation",
    "",
    "When done:",
    "",
    "```bash",
...
function getBootstrapTaskJson(
  ...
  if (profile === "math-physics") {
    return {
      ...
      subtasks: [
        {
          name: "Fill definitions and implementation guidelines",
          status: "pending",
        },
        {
          name: "Define core, math, and physical test expectations",
          status: "pending",
        },
        {
          name: "Add benchmark examples, references, and guides",
          status: "pending",
        },
      ],
      children: [],
      parent: null,
      relatedFiles: [
        ".trellis/spec/definitions/",
        ".trellis/spec/implementation/",
        ".trellis/spec/core-tests/",
        ".trellis/spec/math-tests/",
        ".trellis/spec/phy-tests/",
        ".trellis/spec/guides/",
      ],
      notes:
